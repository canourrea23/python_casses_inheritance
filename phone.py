...
frank_phone = Android('888-777-3333', 'black', 8.5)
...
carolina_phone = IPhone('800-638-1159', 'space gray', 6.9)

carolina_phone.view_battery_life()
carolina_phone.charge_phone(200)
carolina_phone.view_battery_life()
carolina_phone.view_phone_number()

carolina_phone.call('859-699-0000')
carolina_phone.open_app('Zoom')
